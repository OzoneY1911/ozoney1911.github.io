...
<video width="640" height="480" style="display: block; margin: 0 auto; border-top-left-radius: 10% ;" loop autoplay muted>
  <source src="/assets/videos/projectamethyst/pa_menu.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video width="640" height="480" style="display: block; margin: 0 auto; border-radius: 10% 10%;" loop autoplay muted>
